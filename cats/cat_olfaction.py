...
class CatOlfaction:
    ...
    def _sniff_entity(
        ...
        # Není to nové pachové pole.
        # Pouze senzorová aproximace:
        # vzdálenější zdroj vnímáme slaběji.
        distance_factor = (
            1.0
            / (
                1.0
