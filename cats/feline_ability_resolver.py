...
class FelineAbilityResolver:
    ...
    TEACH_TEACHING = 'teach_teaching'
    GARFIELD_TEACHING_METHOD = 'garfield_teaching_method'
    GARFIELD_META_TEACHING_METHOD = 'garfield_meta_teaching_method'
    OPEN_HUMAN_DOOR = 'open_human_door'
    PAZUZU_METHOD = 'hang_on_handle'
    QUEEN_ELISABETH_METHOD = 'pull_with_paw'
