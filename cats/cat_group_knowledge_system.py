...
class CatGroupKnowledgeSystem:
    ...
    def contribute(
        ...
        if (
            ...
            return {
                "name": (
                    "cat_group_knowledge_contribution_denied"
                ),
        ...
        event = {
            "name": "cat_group_knowledge_contributed",
            "group_id": group_id,
            "cat": cat.name,
            "knowledge_id": knowledge_id,
            "category": category,
    ...
    def share_with_group_members(
        ...
        if record is None:
            return {
                "name": (
                    "cat_group_knowledge_share_denied"
                ),
        ...
        return {
            "name": "cat_group_knowledge_shared",
            "group_id": group_id,
            "knowledge_id": knowledge_id,
            "receivers": receivers,
            "shared": True
    ...
    def transmit_between_groups(
        ...
        if record is None:
            return {
                "name": (
                    "cat_group_knowledge_transmission_denied"
                ),
        ...
        event = {
            "name": (
                "cat_group_knowledge_transmitted"
            ),
            "source_group": source_group_id,
            "target_group": target_group_id,
            "knowledge_id": knowledge_id,
    ...
    def propagate_to_members(
        ...
        if record is None:
            return {
                "name": (
                    "cat_group_knowledge_propagation_denied"
                ),
                "reason": "unknown_knowledge",
                "propagated": False
            }
        ...
        return {
            "name": (
                "cat_group_knowledge_propagated"
            ),
            "group_id": group_id,
            "knowledge_id": knowledge_id,
            "receivers": receivers,
    ...
    def verify(
        ...
        if record is None:
            return {
                "name": (
                    "cat_group_knowledge_verification_denied"
                ),
                "reason": "unknown_knowledge",
                "verified": False
            }
        ...
        member_knowledge = (
            cat.knowledge.setdefault(
                "group_received_knowledge",
                {}
            )
        )

        personal = member_knowledge.get(
            knowledge_id
        )
