class CatOvulationResolver:
    ...
    def record_stimulation(self, female, male=None, amount=1, day=None):
        ...
        current = int(reproduction.get('ovulation_stimulation', 0))
        threshold = int(reproduction.get('ovulation_threshold', self.DEFAULT_THRESHOLD))
    ...
    def resolve(self, female, day=None):
        reproduction = female.reproduction
        stimulation = int(reproduction.get('ovulation_stimulation', 0))
        threshold = int(reproduction.get('ovulation_threshold', self.DEFAULT_THRESHOLD))
