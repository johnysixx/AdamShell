...
class CatGuestResponsibilitySystem:
    ...
    def handle_incident(
        ...
        self.meeting_place.bar_banned_humans.add(
            human_name
        )
        ...
        self._set(
            human,
            "bar_entry_ban_reason",
            "cat_invited_guest_incident"
        )
        ...
        cat.meow_invitations[
            "suspension_reason"
        ] = "invited_guest_misbehavior"

        incident = {
            "name": "cat_invited_guest_incident",
            "human": human_name,
            ...
            "human_banned": True,
            "cat_MEOW_suspended": True,
            "suspended_until_tick": suspended_until,
