...
class CatGroupMemorySystem:
    ...
    def remember_encounter(
        ...
        self._apply(
            first_memory,
            event,
            own_group_id=first_group_id
        )

        self._apply(
            second_memory,
            event,
            own_group_id=second_group_id
        )

        return {
            "name": "cat_group_encounter_remembered",
    ...
    def record_betrayal(
        ...
        event = {
            "name": "cat_group_betrayal",
            "betrayer": betrayer_group_id,
            "victim": victim_group_id,
            "reason": reason,
            "betrayal": True
        }
