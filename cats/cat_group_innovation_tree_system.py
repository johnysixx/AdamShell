...
class CatGroupInnovationTreeSystem:
    ...
    def register(
        ...
        if innovation is None:
            return {
                "name": "cat_innovation_tree_denied",
        ...
        tree[
            ...
            "generation": (
                0
                if parent_innovation_id is None
                else int(
                    tree.get(
        ...
        if (
            parent_innovation_id is not None
            and parent_innovation_id in tree
        ):
            children = tree[
                parent_innovation_id
            ][
        ...
        return {
            "name": "cat_innovation_tree_registered",
            "group_id": group_id,
            "innovation_id": innovation_id,
            "parent": parent_innovation_id,
