...
class CatGroupInnovationSystem:
    ...
    def combine(
        ...
        if len(
            ...
            return {
                "name": "cat_group_innovation_denied",
                "reason": (
        ...
        # A new synthesis begins less certain
        # than its source facts.
        confidence *= 0.70
        ...
        event = {
            "name": "cat_group_innovation_created",
            "group_id": group_id,
            "innovation_id": innovation_id,
    ...
    def trial(
        ...
        if innovation is None:
            return {
                "name": "cat_group_innovation_trial_denied",
        ...
        return {
            "name": "cat_group_innovation_trial",
            "group_id": group_id,
            "innovation_id": innovation_id,
            "success": bool(
                success
