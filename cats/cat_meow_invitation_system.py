...
class CatMeowInvitationSystem:
    ...
    def offer(self, cat, human):
        ...
        invitation = {'id': invitation_id, 'name': 'cat_MEOW_invitation', 'cat': cat.name, 'human': self._name(human), 'escort_required': True, 'sound': 'MEOW', 'meaning': 'follow_me', 'offered': True, 'understood': None, 'accepted': False, 'used': False}
