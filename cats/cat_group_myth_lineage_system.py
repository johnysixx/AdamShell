...
class CatGroupMythLineageSystem:
    ...
    def register_origin(
        ...
        return {
            "name": "cat_myth_lineage_registered",
            "group_id": group_id,
            "myth_id": myth_id,
            "registered": True
        }
    ...
    def register_descendant(
        ...
        if child_myth_id not in lineage[
            "versions"
        ]:
            lineage[
                "versions"
        ...
        return {
            "name": "cat_myth_descendant_registered",
            "group_id": group_id,
