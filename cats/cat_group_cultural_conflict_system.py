...
class CatGroupCulturalConflictSystem:
    ...
    def compare(
        ...
        first_preferences = first_culture[
            "preferences"
        ]

        second_preferences = second_culture[
            "preferences"
        ]
        ...
        first_traits = first_culture[
            "traits"
        ]

        second_traits = second_culture[
            "traits"
        ]
    ...
    def interact(
        ...
        event = {
            "name": (
                "cat_group_cultural_interaction"
            ),
            **result,
