class ExistenceResolver:
    ...
    @staticmethod
    def remove_from_strongest_world(
        entity
    ):
        strongest_world = (
            ExistenceResolver
        ...
        if strongest_world is None:
            return {
                "world": None,
                "removed_existence_pct": 0.0
            }

        removed_existence_pct = float(
