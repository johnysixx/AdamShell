...
class Day0GodBrowsesDrinkMenuTests(
    unittest.TestCase
):
    ...
    def test_god_looks_around_after_entering(
        self
    ):
        result = (
            self.scene
            .advance_to_god_browsing_menu()
        )
    ...
    def test_god_moves_to_menu_and_browses_drinks(
        self
    ):
        result = (
            self.scene
    ...
    def test_lilith_and_serpent_continue_talking_while_god_browses(
        self
    ):
        result = (
            self.scene
    ...
    def test_order_of_events(
        ...
        look = names.index(
            "god_looks_around_bar"
        )

        continue_talk = names.index(
            "serpent_and_lilith_continue_wine_discussion"
        )

        menu = names.index(
            "god_browses_drink_menu"
        )
