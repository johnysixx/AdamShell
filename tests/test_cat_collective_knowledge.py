...
class CatCollectiveKnowledgeTests(unittest.TestCase):
    ...
    def test_cat_remembers_discovered_place(self):
        place = CatKnowledge.remember_place(cat=self.cat, layer='quantum_layer', position=SpatialVector3(x=10.0, y=2.0, z=-1.0), safe=True, universe_tick=10)
    ...
    def test_second_visit_increases_confidence(self):
        first = CatKnowledge.remember_place(self.cat, 'quantum_layer', SpatialVector3(x=10.0, y=2.0, z=-1.0))
        second = CatKnowledge.remember_place(self.cat, 'quantum_layer', SpatialVector3(x=10.0, y=2.0, z=-1.0))
    ...
    def test_cat_can_publish_legend(self):
        place = CatKnowledge.remember_place(self.cat, 'quantum_layer', SpatialVector3(x=5.0, y=0.0, z=0.0))
    ...
    def test_other_cat_confirms_existing_legend(self):
        first_place = CatKnowledge.remember_place(self.cat, 'quantum_layer', SpatialVector3(x=5.0, y=0.0, z=0.0))
        ...
        second_place = CatKnowledge.remember_place(other, 'quantum_layer', SpatialVector3(x=5.0, y=0.0, z=0.0))
