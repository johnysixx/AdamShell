...
class Day0SecondWineIdeaTests(
    ...
    def test_bartender_asks_god_what_he_wants(
        self
    ):
        result = (
            self.scene
            .advance_to_second_wine_idea()
        )
    ...
    def test_god_is_still_choosing_and_orders_nothing(
        self
    ):
        result = (
            self.scene
    ...
    def test_lilith_adds_sweetness_as_wine_property(
        self
    ):
        result = (
            self.scene
    ...
    def test_wine_discussion_now_has_two_ideas(
        self
    ):
