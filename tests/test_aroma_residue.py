...
class AromaResidueTests(
    ...
    def test_aroma_can_transfer_to_object(
        self
    ):
        box = (
            self.universe
    ...
    def test_other_cat_can_smell_residue_on_box(
        self
    ):
        box = (
            self.universe
