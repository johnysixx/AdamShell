...
class KittenLateEducationTests(
    unittest.TestCase
):
    ...
    def setUp(self):
        ...
        self.dice_teacher = self.cats.create_cat(
            name="dice_teacher",
            color="gray",
            fur_length="short",
    ...
    def complete_hunting_education(self):
        # První úspěšné cvičné zabití.
        self.run_at_age(35)

        # Tři rodinné lovy dokončí výuku.
    ...
    def test_vocalizations_are_taught_one_per_day(self):
        ...
        self.assertEqual(
            lessons[0]["vocalization"],
            "food_request"
        )

    def test_repertoire_is_complete_on_day_sixty_seven(
        self
    ):
    ...
    def test_human_communication_is_learned_on_day_75(
        self
    ):
        self.teach_all_vocalizations()
    ...
    def test_mother_transmits_meow_on_day_90(self):
        ...
        self.assertTrue(
            meow_event["transmitted"]
        )

        self.assertEqual(
            meow_event["teacher_role"],
            "biological_mother"
        )
    ...
    def test_qualified_cat_teaches_orphaned_kitten(self):
        ...
        # Matku odstraníme ze seznamu dostupných koček.
        self.cats.cats.remove(
            self.mother
        )

        lesson = self.abilities.teach_method(
            teacher=self.garfield,
            student=self.dice_teacher,
    ...
    def test_unqualified_cat_cannot_replace_mother(self):
        ...
        # Garfield by jinak osiřelé kotě
        # rád a oprávněně naučil sám.
        self.cats.cats.remove(
            self.garfield
        )
