...
class FelineAbilityLearningTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        FelineWisdom.ensure_state(self.dice_teacher, can_transmit_meow=True)
        self.resolver.register_pazuzu_door_method(self.pazuzu)
        self.resolver.register_queen_elisabeth_door_method(self.queen)
        self.resolver.register_garfield_teaching_abilities(self.garfield)
        self.resolver.teach_method(teacher=self.garfield, student=self.pazuzu, ability_name='teach_other_cats', method_name='garfield_teaching_method')
        self.resolver.teach_method(teacher=self.garfield, student=self.queen, ability_name='teach_other_cats', method_name='garfield_teaching_method')
