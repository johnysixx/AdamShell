...
class CatQuantumBoxLayerVisibilityTests(
    unittest.TestCase
):
    ...
    def test_cat_only_sees_box_in_current_layer(
        self
    ):
    ...
    def test_cat_only_smells_box_in_current_layer(
        self
    ):
    ...
    def test_local_box_still_knows_counterpart(
        self
    ):
        self.assertTrue(
            self.source[
