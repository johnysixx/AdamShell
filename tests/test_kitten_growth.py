...
class KittenGrowthTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.initial_size = self.kitten.size
        self.initial_strength = self.kitten.strength
    ...
    def test_first_kill_causes_growth(self):
        ...
        self.assertGreater(self.kitten.cronenberg_mass_eaten, 0.0)
    ...
    def test_father_delivery_causes_growth(self):
        self.kitten.upbringing = self.upbringing._create_upbringing_state()
        size_before = self.kitten.size
    ...
    def test_growth_updates_existing_food_statistics(self):
        self.run_day(35)
        self.run_day(36)
        self.assertGreaterEqual(self.kitten.cronenbergs_eaten, 2)
        self.assertGreater(self.kitten.cronenberg_mass_eaten, 0.0)
