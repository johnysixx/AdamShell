...
class CatGroupDynamicsTests(
    ...
    def test_group_has_dynamic_influence_ranking(
        self
    ):
    ...
    def test_group_bonding_can_raise_cohesion(
        self
    ):
        bonding = (
            CatGroupBondingSystem(
    ...
    def test_group_bond_does_not_create_personal_bond(
        self
    ):
        bonding = (
            CatGroupBondingSystem(
    ...
    def test_group_can_vote_candidate_in(
        self
    ):
        recruitment = (
            CatGroupRecruitmentSystem(
        ...
        self.assertTrue(
            self.candidate.group[
                "member"
            ]
        )

    def test_severe_hostility_can_veto_candidate(
        self
    ):
    ...
    def test_defending_group_increases_future_influence(
        self
    ):
        self.first.personality.setdefault(
            "traits",
