...
class CatPersonalityTeachingTests(
    unittest.TestCase
):
    ...
    def setUp(self):
        ...
        self.student = self.cats.create_cat(
            name="student",
            color="gray",
            fur_length="short",
    ...
    def test_successful_lesson_shapes_teacher(
        self
    ):
    ...
    def test_successful_lesson_builds_student_curiosity(
        self
    ):
        result = self.resolver.teach_method(
            teacher=self.garfield,
    ...
    def test_denied_lesson_changes_no_personality(
        self
    ):
        unqualified = self.cats.create_cat(
            name="unqualified",
            color="white",
            fur_length="short",
            origin="natural_birth"
