...
class Day0LilithDrinkOriginTests(
    unittest.TestCase
):
    ...
    def test_sugar_exists_from_bar_start(
        self
    ):
        sugar = (
            self.bar
    ...
    def test_bartender_brings_lemon_into_stock(
        self
    ):
    ...
    def test_vodka_with_lemon_is_basic_and_has_no_effects(
        self
    ):
        self.scene.bartender_returns_with_lemon()
        ...
        drink = (
            self.scene
            .bartender_makes_vodka_with_lemon()
        )
    ...
    def test_lilith_recipe_uses_whole_lemon_and_sugar_cube(
        self
    ):
        self.scene.bartender_returns_with_lemon()
    ...
    def test_lilith_has_only_energy_and_creative_will_effects(
        self
    ):
        self.scene.bartender_returns_with_lemon()
    ...
    def test_lilith_effect_increases_energy_and_creative_will(
        self
    ):
        self.scene.bartender_returns_with_lemon()
