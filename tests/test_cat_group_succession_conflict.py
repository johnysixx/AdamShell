...
class CatGroupSuccessionConflictTests(
    unittest.TestCase
):
    ...
    def test_role_can_pass_to_successor(
        self
    ):
        roles = CatGroupRoleSystem(
            self.groups
        )
        ...
        self.assertIn(
            "guardian",
            self.second.group_roles[
                "active"
            ]
        )

    def test_departure_can_trigger_succession(
        self
    ):
        roles = CatGroupRoleSystem(
            self.groups
        ...
        result = succession.handle_departure(
            self.group_id,
            self.first,
            self.cats.cats
        )
    ...
    def test_missing_successor_weakens_institution(
        self
    ):
        roles = CatGroupRoleSystem(
            self.groups
        ...
        # Make every other cat unsuitable.
        for cat in (
            self.second,
            self.third
        ):
    ...
    def test_shared_role_can_create_institutional_friction(
        self
    ):
        self._institutions()
    ...
    def test_conflict_weakens_both_institutions(
        self
    ):
        self._institutions()
    ...
    def test_mediator_can_resolve_conflict(
        self
    ):
        self._institutions()

        self.third.personality.setdefault(
            "traits",
            {}
        )[
            "sociability"
