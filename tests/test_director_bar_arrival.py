...
class DirectorBarArrivalTests(unittest.TestCase):
    ...
    def test_director_arrives_at_bar_with_liquid_hydrocarbon_sample_and_meets_serpent(
        self
    ):
        universe = Universe()
