...
class CatBoxAromaExchangeTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.garfield = self.cats.create_cat(name='garfield', color='orange', fur_length='short')
        self.pazuzu.current_layer = 'meeting_place'
        self.garfield.current_layer = 'meeting_place'
    ...
    def test_unused_box_has_no_aroma(self):
        self.assertFalse(hasattr(self.source, 'aroma'))
        self.assertFalse(hasattr(self.target, 'aroma'))
