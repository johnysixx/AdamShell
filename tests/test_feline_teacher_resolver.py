...
class FelineTeacherResolverTests(
    unittest.TestCase
):
    ...
    def test_cat_without_awareness_cannot_search(self):
        result = self.teachers.find_teachers(
            student=self.kitten,
    ...
    def test_named_cat_must_really_know_ability(self):
        ordinary_cat = self.cats.create_cat(
            name="ordinary_cat",
            color="gray",
            fur_length="short",
    ...
    def test_cat_can_choose_pazuzu_method(self):
        ...
        result = self.teachers.choose_teacher(
            student=self.kitten,
            ability_name="open_human_door",
    ...
    def test_request_lesson_teaches_real_method(self):
        ...
        result = self.teachers.request_lesson(
            student=self.kitten,
            ability_name="open_human_door",
            method_name="hang_on_handle",
            ability_resolver=self.abilities
        )
