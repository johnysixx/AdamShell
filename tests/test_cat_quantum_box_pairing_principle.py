...
class CatQuantumBoxPairingPrincipleTests(
    unittest.TestCase
):
    ...
    def test_pairing_is_known_as_principle_not_as_route(
        self
    ):
        knowledge = (
            CatKnowledge
        ...
        # Te? v?, ?e jde o quantum box,
        # a z principu v?, ?e m? druhou stranu.
        self.assertTrue(
            after[
        ...
        # Ale konkr?tn? druhou stranu nezn?.
        self.assertFalse(
            after[
                "counterpart_known"
            ]
    ...
    def test_disappearing_box_leaves_memory_not_perception(
        self
    ):
        result = self.explore_box()
