...
class CatOlfactionTests(
    ...
    def test_cat_can_smell_other_cat(
        self
    ):
    ...
    def test_unknown_cat_smell_is_not_identified(
        self
    ):
        result = CatOlfaction.sniff(
            self.observer,
    ...
    def test_cat_learns_specific_cat_smell(
        self
    ):
    ...
    def test_surface_smell_does_not_destroy_identity(
        self
    ):
        self.cats.learn_cat_aroma(
            self.observer,
    ...
    def test_ozone_can_be_detected_without_understanding_it(
        self
    ):
        fake_cronenberg = type(
            "FakeCronenberg",
            (),
            {}
        )()
        ...
        fake_cronenberg.position = {
            "x": 3.0,
            "y": 0.0,
            "z": 0.0
        }

        fake_cronenberg.aroma = (
            AromaProfile.create(
                "cronenberg",
                {
                    "ozone": 1.0,
        ...
        self.universe.cronenbergs.append(
            fake_cronenberg
        )
    ...
    def test_experienced_cat_recognizes_cronenberg_ozone(
        self
    ):
        fake_cronenberg = type(
            "FakeCronenberg",
        ...
        self.cats.learn_aroma(
            cat=self.observer,
            identity="cronenberg",
            components=(
                AromaProfile.current(
                    fake_cronenberg.aroma
                )
            ),
            source=(
