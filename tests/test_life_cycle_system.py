...
class LifeCycleSystemTests(unittest.TestCase):
    ...
    def test_life_cycle_does_not_advance_before_big_bang(self):
        kitten = self.cats.create_cat(name='kitten', color='black', fur_length='short', sex='female')
    ...
    def test_universe_tick_advances_newborn_age(self):
        ...
        self.assertEqual(kitten.age_days, 1)
        self.assertEqual(self.universe.life_cycle_system.day, 1)
