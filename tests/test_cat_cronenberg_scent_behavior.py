...
class CatCronenbergScentBehaviorTests(
    unittest.TestCase
):
    ...
    def observations(self):
        return {
            ...
            "cronenberg_scent_recognized": True,
            "smelled_cronenbergs": [
                {
                    "entity_id": "cronenberg_test",
                    "recognition": {
                        "recognized": True,
                        "identity": "cronenberg"
                    }
    ...
    def test_brave_cat_tracks_cronenberg_scent(
        self
    ):
        traits = self.cat[
            "personality"
    ...
    def test_cautious_cat_avoids_cronenberg_scent(
        self
    ):
        traits = self.cat[
            "personality"
    ...
    def test_unknown_ozone_does_not_mean_cronenberg(
        self
    ):
        observations = self.observations()
