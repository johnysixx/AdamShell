...
class CatGroupRitualSpecializationTests(
    unittest.TestCase
):
    ...
    def test_defined_ritual_has_lineage_origin(
        self
    ):
    ...
    def test_ritual_can_mutate_into_descendant(
        self
    ):
        rituals = CatGroupRitualSystem(
            self.groups
    ...
    def test_guardian_can_specialize(
        self
    ):
        cat = self.members[0]
        ...
        result = specialization.specialize(
            self.group_id,
            cat,
            "guardian",
            "night_guardian"
    ...
    def test_specialization_requires_base_role(
        self
    ):
        specialization = (
            CatGroupRoleSpecializationSystem(
    ...
    def test_institution_is_inherited_after_group_split(
        self
    ):
        institutions = (
            CatGroupInstitutionSystem(
