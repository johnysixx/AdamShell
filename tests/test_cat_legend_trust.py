...
class CatLegendTrustTests(
    ...
    def test_heard_legend_is_not_fact(
        self
    ):
        heard = CatKnowledge.hear_legend(
    ...
    def test_trust_changes_credibility(
        self
    ):
        self.listener[
            "relationships"
        ...
        self.assertGreater(
            trusted["credibility"],
            skeptical["credibility"]
        )

    def test_planner_can_use_credible_legend(
        self
    ):
        self.listener[
            "relationships"
    ...
    def test_personal_visit_verifies_legend(
        self
    ):
        CatKnowledge.hear_legend(
            self.listener,
