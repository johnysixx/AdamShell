...
class CatScentPlaceMemoryTests(unittest.TestCase):
    ...
    def sniff_and_remember(self):
        olfaction = CatOlfaction.sniff(self.observer, self.universe)
        return CatKnowledge.remember_olfaction(cat=self.observer, olfaction=olfaction, current_layer='quantum_layer', universe_tick=10)
