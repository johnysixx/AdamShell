...
class Day0AcidityWineIdeaTests(
    unittest.TestCase
):
    ...
    def test_serpent_explains_existing_ideas_to_god(
        self
    ):
        result = (
            self.scene
            .advance_to_acidity_wine_idea()
        )
    ...
    def test_lilith_rejects_bitterness(
        self
    ):
        result = (
            self.scene
    ...
    def test_lilith_proposes_acidity(
        self
    ):
        result = (
            self.scene
    ...
    def test_current_hypothesis_replaces_bitterness_with_acidity(
        self
    ):
    ...
    def test_lilith_gives_serpent_her_drink_to_taste(
        self
    ):
        result = (
            self.scene
    ...
    def test_serpent_receives_lilith_effect_on_tasting(
        self
    ):
        self.scene.advance_to_god_at_table()

        energy_before = float(
            self.scene.serpent.get(
                "energy_j",
                0.0
            )
        )
    ...
    def test_discussion_stays_unresolved(
        self
    ):
        self.scene.advance_to_acidity_wine_idea()
