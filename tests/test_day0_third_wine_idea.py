...
class Day0ThirdWineIdeaTests(
    ...
    def test_god_finishes_browsing_and_orders_lilith(
        self
    ):
        result = (
            self.scene
            .advance_to_third_wine_idea()
        )
    ...
    def test_serpent_tastes_mead_then_beer(
        self
    ):
        result = (
            self.scene
        ...
        mead_index = names.index(
            "serpent_tastes_mead"
        )

        beer_index = names.index(
            "serpent_tastes_beer"
        )
    ...
    def test_serpent_says_sweetness_is_good_but_not_full_body(
        self
    ):
        result = (
            self.scene
    ...
    def test_serpent_proposes_bitterness(
        self
    ):
        result = (
            self.scene
    ...
    def test_wine_discussion_has_three_ideas(
        self
    ):
