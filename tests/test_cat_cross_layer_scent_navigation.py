...
class CatCrossLayerScentNavigationTests(
    unittest.TestCase
):
    ...
    def test_perception_detects_cross_layer_scent(
        self
    ):
    ...
    def test_mind_can_choose_to_follow_scent_through_box(
        self
    ):
        perception = CatPerception(
            self.cats
