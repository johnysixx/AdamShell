...
class Day0SerpentMovesBeforeBartenderReturnsTests(
    unittest.TestCase
):
    ...
    def test_they_agree_on_table_before_bartender_returns(
        self
    ):
        event = (
            self.scene
            .serpent_and_lilith_agree_on_table()
        )
    ...
    def test_serpent_moves_to_existing_table_first(
        self
    ):
        ...
        event = (
            self.scene
            .serpent_moves_from_bar_to_existing_table()
        )
    ...
    def test_lilith_remains_at_bar_when_serpent_leaves(
        self
    ):
        self.scene.serpent_and_lilith_agree_on_table()
    ...
    def test_bartender_returns_to_find_only_lilith_at_counter(
        self
    ):
        self.scene.serpent_and_lilith_agree_on_table()
