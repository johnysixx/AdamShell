...
class CatMaternalCareSystemTests(
    unittest.TestCase
):
    ...
    def test_neonatal_kitten_gets_complete_care(
        self
    ):
    ...
    def test_warming_stops_after_neonatal_phase(
        self
    ):
        result = self.care.provide_care(
            self.mother,
    ...
    def test_weaning_phase_keeps_reduced_care(
        self
    ):
        result = self.care.provide_care(
            self.mother,
    ...
    def test_independent_kitten_is_no_longer_nursed(
        self
    ):
        result = self.care.provide_care(
            self.mother,
    ...
    def test_maternal_care_is_persisted(
        self
    ):
    ...
    def test_non_mother_cannot_provide_maternal_care(
        self
    ):
