...
class CatGroupWorldBehaviorTests(
    unittest.TestCase
):
    ...
    def test_group_lifecycle_reaches_stable_state(
        self
    ):
    ...
    def test_group_can_migrate_together(
        self
    ):
        group_id = self._group(
            self.members[:3],
    ...
    def test_two_groups_can_have_territorial_conflict(
        self
    ):
        first = self._group(
            self.members[:3],
    ...
    def test_group_conflict_increments_history(
        self
    ):
        first = self._group(
            self.members[:3],
    ...
    def test_group_can_split_into_daughter_group(
        self
    ):
        group_id = self._group(
            self.members[:4],
