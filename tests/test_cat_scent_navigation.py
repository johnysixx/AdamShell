...
class CatScentNavigationTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        CatKnowledge.remember_scent_place(cat=self.cat, layer='quantum_layer', position=SpatialVector3(x=5.0, y=0.0, z=0.0), source_id='box_pazuzu', recognized_identity='cat:pazuzu', components={'cat': 1.0, 'fur': 0.8}, perceived_intensity=0.8, universe_tick=10)
    ...
    def test_planner_remembers_strongest_scent_place(self):
        ...
        self.assertEqual(
            result.position,
            SpatialVector3(x=5.0, y=0.0, z=0.0)
        )

    def test_known_scent_navigation_prefers_current_layer(self):
        from cats.cat_knowledge import CatKnowledge
        CatKnowledge.remember_scent_place(cat=self.cat, layer='meeting_place', position=SpatialVector3(x=99.0, y=0.0, z=0.0), source_id='old_pazuzu_trace', recognized_identity='cat:pazuzu', components={'cat': 1.0, 'individual_cat:pazuzu': 2.0}, perceived_intensity=1.0, universe_tick=1)
        ...
        CatKnowledge.remember_scent_place(cat=self.cat, layer='quantum_layer', position=SpatialVector3(x=7.0, y=0.0, z=0.0), source_id='local_pazuzu_trace', recognized_identity='cat:pazuzu', components={'cat': 0.4, 'individual_cat:pazuzu': 0.8}, perceived_intensity=0.3, universe_tick=2)
        candidates = CatMind.consider(cat=self.cat, observations=self.observations())
    ...
    def test_fresh_scent_beats_old_stronger_memory(self):
        ...
        CatKnowledge.remember_scent_place(cat=self.cat, layer='quantum_layer', position=SpatialVector3(x=2.0, y=0.0, z=0.0), source_id='old_strong_trace', recognized_identity='cat:pazuzu', components={}, perceived_intensity=1.0, universe_tick=0)
        CatKnowledge.remember_scent_place(cat=self.cat, layer='quantum_layer', position=SpatialVector3(x=8.0, y=0.0, z=0.0), source_id='fresh_trace', recognized_identity='cat:pazuzu', components={}, perceived_intensity=0.4, universe_tick=195)
    ...
    def test_ancient_scent_remains_memory_but_not_navigation_target(self):
        from cats.cat_knowledge import CatKnowledge
        self.cat.knowledge.known_scent_places = []
        CatKnowledge.remember_scent_place(cat=self.cat, layer='quantum_layer', position=SpatialVector3(x=5.0, y=0.0, z=0.0), source_id='ancient_trace', recognized_identity='cat:pazuzu', components={}, perceived_intensity=1.0, universe_tick=0)
    ...
    def test_cat_infers_direction_from_scent_points(self):
        from cats.cat_knowledge import CatKnowledge
        self.cat.knowledge.known_scent_places = []
        CatKnowledge.remember_scent_place(cat=self.cat, layer='quantum_layer', position=SpatialVector3(x=1.0, y=0.0, z=0.0), source_id='trace_a', recognized_identity='cat:pazuzu', components={}, perceived_intensity=0.4, universe_tick=10)
        CatKnowledge.remember_scent_place(cat=self.cat, layer='quantum_layer', position=SpatialVector3(x=4.0, y=0.0, z=0.0), source_id='trace_b', recognized_identity='cat:pazuzu', components={}, perceived_intensity=0.6, universe_tick=20)
        ...
        self.assertEqual(result.vector, SpatialVector3(x=3.0, y=0.0, z=0.0))
        self.assertEqual(result.unit_vector, SpatialVector3(x=1.0, y=0.0, z=0.0))
        self.assertEqual(result.tick_delta, 10)

    def test_follow_known_scent_contains_inferred_direction(self):
        from cats.cat_knowledge import CatKnowledge
        self.cat.knowledge.known_scent_places = []
        CatKnowledge.remember_scent_place(cat=self.cat, layer='quantum_layer', position=SpatialVector3(x=1.0, y=1.0, z=0.0), source_id='trace_1', recognized_identity='cat:pazuzu', components={}, perceived_intensity=0.4, universe_tick=10)
        CatKnowledge.remember_scent_place(cat=self.cat, layer='quantum_layer', position=SpatialVector3(x=2.0, y=2.0, z=0.0), source_id='trace_2', recognized_identity='cat:pazuzu', components={}, perceived_intensity=0.8, universe_tick=20)
        self.cat.knowledge.scent_clock_tick = 20
        candidates = CatMind.consider(cat=self.cat, observations=self.observations())
        scent = next((candidate for candidate in candidates if candidate.type == 'follow_known_scent'))
