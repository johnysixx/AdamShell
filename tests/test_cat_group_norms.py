...
from cats.cat_group_sanction_system import (
    CatGroupSanctionSystem
)
...
class CatGroupNormTests(
    ...
    def test_group_can_define_norm(
        self
    ):
        norms = CatGroupNormSystem(
            self.groups
        )
    ...
    def test_cat_can_violate_norm(
        ...
        created = norms.define(
            self.group_id,
            "do_not_disturb_sleep",
            "social",
            {
                "action": "avoid_disturbing_sleep"
            },
            importance=0.5
        )
    ...
    def test_group_can_define_taboo(
        self
    ):
        taboo = CatGroupTabooSystem(
            self.groups
        )
    ...
    def test_taboo_violation_can_recommend_expulsion(
        self
    ):
        taboo = CatGroupTabooSystem(
            self.groups
    ...
    def test_repeated_minor_violations_escalate(
        self
    ):
        norms = CatGroupNormSystem(
            self.groups
    ...
    def test_norm_can_belong_to_institution(
        self
    ):
        institutions = (
            CatGroupInstitutionSystem(
