...
class Day0BartenderJudgeProposalAndWaterTests(
    unittest.TestCase
):
    ...
    def test_serpent_orders_water_at_bar(
        self
    ):
        result = (
            self.scene
    ...
    def test_god_rejects_participant_vote(
        self
    ):
        result = (
            self.scene
    ...
    def test_god_proposes_bartender_as_judge(
        self
    ):
        result = (
            self.scene
    ...
    def test_bartender_judge_proposal_is_not_accepted_yet(
        self
    ):
    ...
    def test_lilith_and_god_move_to_bar(
        self
    ):
        self.scene.advance_to_everyone_at_bar_with_serpents_water()
    ...
    def test_serpent_gets_water_with_free_lemon_slice(
        self
    ):
        result = (
            self.scene
    ...
    def test_lemon_slice_does_not_consume_whole_lemon(
        self
    ):
