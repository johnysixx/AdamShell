...
class CatQuantumExplorationContinuationTests(
    unittest.TestCase
):
    ...
    def reach_first_goal(self):
        ...
        self.fail(
            "Kočka nedorazila k prvnímu cíli."
        )

    def test_continue_exploration_starts_new_route(
        self
    ):
    ...
    def test_continuation_does_not_create_new_pair(
        self
    ):
        self.assertEqual(
            len(
    ...
    def test_return_anchor_survives_continuation(
        self
    ):
        self.reach_first_goal()
    ...
    def test_second_goal_is_different(
        self
    ):
        first_goal = dict(
            self.cat[
