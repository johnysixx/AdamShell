...
class CatAutonomousExplorationPairTests(
    unittest.TestCase
):
    ...
    def test_perception_offers_pair_creation_without_box(
        self
    ):
        observations = (
    ...
    def test_cat_mind_selects_pair_creation(
        self
    ):
        observations = (
            self.cats.observe_cat(
    ...
    def test_existing_unexplored_box_is_preferred(
        self
    ):
        box = (
            self.universe
